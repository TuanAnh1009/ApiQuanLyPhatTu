...
namespace QlyPhatTu.Migrations
{
    ...
    [Migration("20230720131803_update_daotrang_phattu")]
    partial class update_daotrang_phattu
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QlyPhatTu.Models.Role", b =>
                {
            ...
            modelBuilder.Entity("QlyPhatTu.Models.UserRoles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QlyPhatTu.Models.UserRoles", b =>
                {
                    b.HasOne("QlyPhatTu.Models.PhatTu", "PhatTu")
                        .WithOne("UserRoles")
                        .HasForeignKey("QlyPhatTu.Models.UserRoles", "PhatTuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QlyPhatTu.Models.Role", "Role")
                        .WithMany()
